...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=tech.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6b, 0x22, 0xac, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x14,
	0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x12, 0x2c, 0x0a, 0x04, 0x75, 0x6e, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x18, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b,
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: tech.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: tech.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: tech.pcbook.Memory.unit:type_name -> tech.pcbook.Memory.Unit
